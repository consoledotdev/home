import Noise from "@/app/misc/noise.ts";
...
export class Rays {
    ...
    initializeParameters() {
        this.params = {
            ...
            spread_in_amt: {
                ...Rays.defaults().spread_in_amt,
                ...this.options.params.spread_in_amt,
            },
            spread_in_length: {
                ...Rays.defaults().spread_in_length,
                ...this.options.params.spread_in_length,
            },
            x: { ...Rays.defaults().x, ...this.options.params.x },
            x_offset: {
                ...Rays.defaults().x_offset,
                ...this.options.params.x_offset,
            },
            x_motion: {
                ...Rays.defaults().x_motion,
                ...this.options.params.x_motion,
            },
            y: { ...Rays.defaults().y, ...this.options.params.y },
            y_offset: {
                ...Rays.defaults().y_offset,
                ...this.options.params.y_offset,
            },
            y_slide_in_amt: {
                ...Rays.defaults().y_slide_in_amt,
                ...this.options.params.y_slide_in_amt,
            },
            y_slide_in_length: {
                ...Rays.defaults().y_slide_in_length,
                ...this.options.params.y_slide_in_length,
            },
            h: { ...Rays.defaults().h, ...this.options.params.h },
            h_offset: {
                ...Rays.defaults().h_offset,
                ...this.options.params.h_offset,
            },
            hue_in: { ...Rays.defaults().hue_in, ...this.options.params.hue_in },
            hue_out: {
                ...Rays.defaults().hue_out,
                ...this.options.params.hue_out,
            },
            parallax: {
                ...Rays.defaults().parallax,
                ...this.options.params.parallax,
            },
            parallax_offset: {
                ...Rays.defaults().parallax_offset,
                ...this.options.params.parallax_offset,
            },
        };
        this.changeSeed();
  ...
  */
    ...
    animateIn() {
        setTimeout(() => {
            this.slideInProgress = this.params.y_slide_in_length.value * this.fpsRatio;
            this.spreadInProgress = this.params.spread_in_length.value * this.fpsRatio;
        }, 1200);
    }
