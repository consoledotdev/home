export const meta = {
    ...
    headerType: "fixed",
    intro: () => <>Our goal is to track as little as possible, only collecting what is essential for running Console.</>,
};
...
analytics product that [does not set any
cookies](https://plausible.io/data-policy) and only uses anonymous metrics. We
also use Vercel Analytics, which has [a similar privacy-first
approach](https://vercel.com/docs/concepts/analytics/privacy-policy) without
cookies.
...
2023-05-14 ([change
history](https://github.com/consoledotdev/home/commits/main/app/privacy/content/page.mdx)).
...
London, WC1X 7RJ, UK. Our company number is 13016709 and our UK Data Protection
registration number is ZA837052.
