...
campaigns:
    - name: Slim.AI
      ...
      quote: "“Our campaign with Console was very successful. We saw x5 our usual daily
      ...
      howItWorked:
          - icon: console-offer
            name: Offer
          - text: Slim.AI offered the Console audience an exclusive invite code that
          ...
          - icon: social
            name: Social
          - text: To maximise reach with our audience, Console also ran an interview
    ...
    - name: Liveblocks
      ...
      quote: "“Launching a new company and a new product is always difficult because
      ...
      howItWorked:
          ...
          - icon: delay
            name: Time
          - text: Console scheduled a review to appear in the Console Weekly newsletter
          ...
          - icon: console-interview
            name: Interview
          - text: As part of the launch, Console also published an interview with
          ...
          - icon: social
            name: Social
          - text: The newsletter review also appeared on the Console Tools List,
    ...
    - name: IPInfo
      ...
      quote: "“IPInfo’s API solves quite a specific need, so it is important for us to
      ...
      howItWorked:
          - icon: console-offer
            name: Offer
          - text: IPInfo provided the Console audience with a special discount to
          ...
          - text: To incentivize our audience and deliver new customers, Console worked
          ...
          - icon: social
            name: Social
          - text: To support the promotion, IPInfo’s review was published on the Console
    ...
    - name: Oso
      ...
      quote: "“Oso is breaking new ground in a complex space (authorization). We're
      ...
      howItWorked:
          - icon: console-mini-filled
            name: Schedule
          - text: Console scheduled Oso’s review to appear in the newsletter as part of
                a coordinated launch. Their review, interview and blog post reached
                10k developer inboxes.
          - icon: console-interview
            name: Interview + blog post
          - text: Oso is tackling a challenging problem. To increase engagement and
          ...
          - icon: social
            name: Social
          - text: The newsletter review also appeared at the top of the Console Tools
    ...
    - name: CodeSee
      ...
      intro:
          ...
          - To coordinate with the launch of a new beta release at Hacktoberfest and
            ...
            testers.
      quote: "“Console provided a compelling means to support our launch of CodeSee
      ...
      howItWorked:
          ...
          - icon: delay
            name: Time
          - text: Console scheduled CodeSee’s review and announcement blog post to
          ...
          - icon: link
            name: Beta release
          - text: To drive engagement, CodeSee launched a beta of their open source
          ...
          - icon: console-interview
            name: Blog post
          - text: To deepen engagement and support a wider PR promotion, we included a
    ...
    - name: Mergify
      ...
      intro:
          - Mergify’s CEO approached Console as the perfect partner to help reach an
            ...
            pull requests.
      quote: "“Building Mergify is quite a venture, and bringing it in front of every
      ...
      howItWorked:
          - icon: console-mini-filled
            name: Schedule
          - text: Console coordinated Mergify’s review to appear in the newsletter as
                part of a wider marketing push. Their review, interview and blog post
                reached 15k developer inboxes.
          - icon: console-interview
            name: Interview
          - text: Mergify were eager to deepen developer’s understanding of their
          ...
          - icon: social
            name: Social
          - text: To support the promotion, Mergify’s review was published on the
    ...
    - name: Teleport
      ...
      intro:
          - Console collaborated with Teleport to promote the launch of Teleport 8,
            ...
            launch.
      quote: "“Console was a great addition to our latest product launch at Teleport.
      ...
      howItWorked:
          - icon: console-mini-filled
            name: Schedule
          - text: Timed to coincide with the launch of their latest release, Teleport 8,
                we promoted a review of the release to our audience of engaged
                developers.
          - icon: console-interview
            name: Interview + blog post
          - text: To support the launch, alongside their tool review, we published an an
    ...
    - name: AutoCloud
      ...
      quote: “Console enabled us to quickly reach a large, highly targeted audience,
      ...
      howItWorked:
          - icon: console-interview
            name: Interview
          - text: To support their tool review, Console interviewed their CPO, Evelyn
          ...
          - icon: social
            name: Social
          - text: To support the promotion, AutoCloud’s review was published on the
                Console Tools List and promoted on social media.
          - icon: badges
            name: Badges + banners
          - text: As a profiled ‘Developer Tool of the Week’, AutoCloud received badges
