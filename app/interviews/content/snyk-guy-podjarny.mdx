...
<ImageProvider center src="/img/interviews/snyk-guy-podjarny-product.jpeg" alt="Snyk product screenshot" caption="Security vulnerability dashboard." />
