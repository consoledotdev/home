...
<ImageProvider center src="/img/interviews/seed-jay-v-product.png" alt="Seed product screenshot" caption="Seed deployment pipeline dashboard." />
...
<ImageProvider center src="/img/interviews/seed-jay-v-desk.jpg" alt="The desk of Jay V, Seed" />
