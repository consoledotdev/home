...
<ImageProvider center src="/img/interviews/akita-jean-yang-product.png" alt="Akita product screenshot" caption="Akita API dashboard." />
...
<ImageProvider center src="/img/interviews/akita-jean-yang-desk.jpeg" alt="The desk of Jean Yang, Akita" />
