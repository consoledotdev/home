...
what: We discuss the principles behind encryption, homomorphic encryption, and
...
draft: false
summary: Homomorphic encryption, a devtools discussion with Rand Hindi (Zama). Episode
    6 (Season 2) of the Console Devtools Podcast.
metaDescription: Homomorphic encryption, a devtools discussion with Rand Hindi (Zama). Episode
    6 (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Rand Hindi" />
...
<PodcastEpisodeClipping atTime="15:36">
...
<PodcastEpisodeClipping atTime="23:55">
