...
what: We discuss why open source is such an important differentiator for all
...
draft: false
summary: OSS & Investing - a devtools discussion with Joseph Jacks (OSS Capital).
    Episode 3 (Season 3) of the Console Devtools Podcast.
metaDescription: OSS & Investing - a devtools discussion with Joseph Jacks (OSS Capital).
    Episode 3 (Season 3) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Joseph Jacks" />
...
<PodcastEpisodeClipping atTime="01:22">
...
<PodcastEpisodeClipping atTime="02:28">
