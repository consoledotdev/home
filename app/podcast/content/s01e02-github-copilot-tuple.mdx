...
draft: false
summary: GitHub Copilot (AI pair programming) & Tuple (screen sharing for developers),
    a devtools discussion with David Mytton and Jean Yang.
metaDescription: GitHub Copilot (AI pair programming) & Tuple (screen sharing for developers),
    a devtools discussion with David Mytton and Jean Yang.
headerType: fixed
hideLines: true
hidePlanes: true
