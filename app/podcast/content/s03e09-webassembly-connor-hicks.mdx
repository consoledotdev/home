...
what: We discuss how WebAssembly works, when you’d use AssemblyScript rather than
...
draft: false
summary: WebAssembly - a devtools discussion with Connor Hicks (Suborbital). Episode 9
    (Season 3) of the Console Devtools Podcast.
metaDescription: WebAssembly - a devtools discussion with Connor Hicks (Suborbital). Episode 9
    (Season 3) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Connor Hicks" />
...
<PodcastEpisodeClipping atTime="01:53">
...
<PodcastEpisodeClipping atTime="15:19">
