...
what: We discuss why observability is based around events and not metrics, how
...
draft: false
summary: Observability - a devtools discussion with Charity Majors (Honeycomb). Episode
    3 (Season 2) of the Console Devtools Podcast.
metaDescription: Observability - a devtools discussion with Charity Majors (Honeycomb). Episode
    3 (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Charity Majors" />
...
<PodcastEpisodeClipping atTime="03:36">
...
<PodcastEpisodeClipping atTime="16:25">
