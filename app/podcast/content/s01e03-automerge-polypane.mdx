...
what: "Episode 3 of the Console Devtools Podcast, a devtools discussion with David
...
draft: false
summary: Automerge (conflict-free JSON-like data structure) & Polypane (browser testing
    tool), a devtools discussion with David Mytton and Jean Yang.
metaDescription: Automerge (conflict-free JSON-like data structure) & Polypane (browser testing
    tool), a devtools discussion with David Mytton and Jean Yang.
headerType: fixed
hideLines: true
hidePlanes: true
