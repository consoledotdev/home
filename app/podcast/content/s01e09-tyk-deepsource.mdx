...
what: "Episode 9 of the Console Devtools Podcast, a devtools discussion with David
...
draft: false
summary: Tyk (API gateway) & Deepsource (automated code reviews), a devtools discussion
    with David Mytton and Jean Yang.
metaDescription: Tyk (API gateway) & Deepsource (automated code reviews), a devtools discussion
    with David Mytton and Jean Yang.
headerType: fixed
hideLines: true
hidePlanes: true
