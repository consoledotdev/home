...
what: We discuss the meaning of “developer experience”, how complexity is managed to
...
draft: false
summary: Dev infrastructure - a devtools discussion with Guillermo Rauch (Vercel).
    Episode 1 (Season 3) of the Console Devtools Podcast.
metaDescription: Dev infrastructure - a devtools discussion with Guillermo Rauch (Vercel).
    Episode 1 (Season 3) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Guillermo Rauch" />
...
<PodcastEpisodeClipping atTime="04:00">
...
<PodcastEpisodeClipping atTime="12:09">
