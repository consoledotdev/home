...
what: We discuss the software heterogeneity problem, why it isn't better to rewrite
...
draft: false
summary: Developer experience - a devtools discussion with Jean Yang (Akita). Episode
    11 (Season 2) of the Console Devtools Podcast.
metaDescription: Developer experience - a devtools discussion with Jean Yang (Akita). Episode
    11 (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Jean Yang" />
...
<PodcastEpisodeClipping atTime="12:39">
...
<PodcastEpisodeClipping atTime="18:07">
