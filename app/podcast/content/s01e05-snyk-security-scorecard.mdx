...
what: "Episode 5 of the Console Devtools Podcast, a devtools discussion with David
...
draft: false
summary: Snyk (dependency security monitoring) & Security Scorecard (security health
    metrics), a devtools discussion with David Mytton and Jean Yang.
metaDescription: Snyk (dependency security monitoring) & Security Scorecard (security health
    metrics), a devtools discussion with David Mytton and Jean Yang.
headerType: fixed
hideLines: true
hidePlanes: true
