...
what: We discuss the state of software security in sectors like energy and
...
draft: false
summary: Security - a devtools discussion with Thomas Ptacek (Fly.io). Episode 2
    (Season 2) of the Console Devtools Podcast.
metaDescription: Security - a devtools discussion with Thomas Ptacek (Fly.io). Episode 2
    (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Thomas Ptacek" />
...
<PodcastEpisodeClipping atTime="01:37">
...
<PodcastEpisodeClipping atTime="21:15">
