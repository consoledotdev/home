...
what: We discuss why community is not marketing, how devrel and community are
...
draft: false
summary: Dev communities - a devtools discussion with Rosie Sherry (Orbit). Episode 7
    (Season 2) of the Console Devtools Podcast.
metaDescription: Dev communities - a devtools discussion with Rosie Sherry (Orbit). Episode 7
    (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Rosie Sherry" />
...
<PodcastEpisodeClipping atTime="05:24">
...
<PodcastEpisodeClipping atTime="19:00">
