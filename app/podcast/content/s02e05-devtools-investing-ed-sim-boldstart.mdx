...
what: We discuss what engineers should think about when working on side projects,
...
draft: false
summary: Devtools investing - a devtools discussion with Ed Sim (Boldstart). Episode 5
    (Season 2) of the Console Devtools Podcast.
metaDescription: Devtools investing - a devtools discussion with Ed Sim (Boldstart). Episode 5
    (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Ed Sim" />
...
<PodcastEpisodeClipping atTime="02:54">
...
<PodcastEpisodeClipping atTime="03:27">
