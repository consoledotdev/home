...
what: We discuss the evolution of web tech from websites to complex decentralized
...
draft: false
summary: Web standards & privacy - a devtools discussion with Dees Chinniah (ex-Mozilla
    / Tor). Episode 8 (Season 2) of the Console Devtools Podcast.
metaDescription: Web standards & privacy - a devtools discussion with Dees Chinniah (ex-Mozilla
    / Tor). Episode 8 (Season 2) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Dees Chinniah" />
...
<PodcastEpisodeClipping atTime="18:44">
