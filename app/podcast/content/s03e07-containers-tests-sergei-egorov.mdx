...
what: We discuss the challenges of developing container-based applications, how to
...
draft: false
summary: Containers & Tests - a devtools discussion with Sergei Egorov (Atomic Jar).
    Episode 7 (Season 3) of the Console Devtools Podcast.
metaDescription: Containers & Tests - a devtools discussion with Sergei Egorov (Atomic Jar).
    Episode 7 (Season 3) of the Console Devtools Podcast.
headerType: fixed
hideLines: true
hidePlanes: true
...
<RichTitle tag="h5" icon={{ group: "generic", name: "future-head" }} text="About Sergei Egorov" />
...
<PodcastEpisodeClipping atTime="13:16">
...
<PodcastEpisodeClipping atTime="21:39">
