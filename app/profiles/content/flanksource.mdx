...
metaDescription: What is it like to work at Flanksource? Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Flanksource"
        description: "A platform providing multi-dimensional system visibility with integrated
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Flanksource" />
