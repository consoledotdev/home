...
metaDescription: What is it like to work at CodeSee? Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "CodeSee"
        description: "CodeSee is a developer tool that visualizes how your code works for
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at CodeSee" />
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="key-features" text="Hiring process at CodeSee" />
