...
metaDescription: What is it like to work at Trunk?  Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Trunk"
        description: "Trunk is building a unified DevEx Platform. Currently available for
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Trunk" />
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="key-features" text="Hiring process at Trunk" />
