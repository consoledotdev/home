...
metaDescription: What is it like to work at Snaplet?  Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Snaplet"
        description: "At Snaplet, we provide realistic database snapshots for development and
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Snaplet" />
