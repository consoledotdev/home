...
metaDescription: What is it like to work at AutoCloud?  Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "AutoCloud"
        description: "At AutoCloud our mission is to make DevOps as effortless as possible so
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at AutoCloud" />
