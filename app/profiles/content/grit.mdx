...
metaDescription: What is it like to work at Grit? Console profile behind the scenes at Grit -
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Grit" />
