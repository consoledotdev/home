...
metaDescription: What is it like to work at daily.dev?  Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "daily.dev"
        description: "daily.dev is building a platform where developers can grow together. We
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at daily.dev" />
