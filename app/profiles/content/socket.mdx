...
metaDescription: What is it like to work at Socket? Console profile behind the scenes at Socket - secure your JavaScript supply chain.
headerType: fixed
hideLines: true
hidePlanes: true
...
companyInfo:
    ...
    product:
        name: "Socket"
        description: "Socket builds security infrastructure for the internet. Developers depend
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Socket" />
