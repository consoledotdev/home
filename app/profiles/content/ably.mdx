...
metaDescription: What is it like to work at Ably? Console profile behind the scenes at Ably -
...
companyInfo:
    ...
    product:
        name: "Ably"
        description: "Ably is a suite of simple APIs to develop powerful realtime experiences.
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Ably" />
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="key-features" text="Hiring process at Ably" />
