...
metaDescription: What is it like to work at Replay? Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Replay"
        description: "More than a video. Replay lets you jump to any point in execution, add
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="key-features" text="Hiring process at Replay" />
