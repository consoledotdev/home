...
metaDescription: What is it like to work at Vantage? Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Vantage"
        description: "Vantage gives engineering and finance teams the tools they need to get
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works">
    {" "}
    How engineering works at Vantage
</RichTitle>
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="key-features" text="Hiring process at Vantage" />
