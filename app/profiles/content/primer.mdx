...
metaDescription: What is it like to work at Primer?  Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Primer"
        description: "Primer is an automation platform for payments. It offers unified checkout
    ...
    customerCaseStudies:
        - client: "Voi"
          text: "is Europe's fastest-growing eScooter hire platform. Primer has
        ...
        - client: "Kilo Health"
          text: "supports over 4 million customers globally, with a collection of
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Primer" />
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="key-features" text="Hiring process at Primer" />
