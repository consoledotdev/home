...
metaDescription: What is it like to work at Warp? Console profile behind the scenes at
...
companyInfo:
    ...
    product:
        name: "Warp"
        description: "Warp is a blazingly fast, Rust-based terminal reimagined from the ground
...
<RichTitle tag="h3" icon={{ group: "generic", name: "checklist" }} id="how-engineering-works" text="How engineering works at Warp" />
