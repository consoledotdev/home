...
async function handleEvent(event) {
    ...
    try {
        ...
        const redirectMap = new Map([
            ...
            ["/browser-testing", "https://console.dev/browser-testing/"],
            ["/browser-testing/browserstack", "https://console.dev/browser-testing/browserstack/"],
            ["/browser-testing/crossbrowsertesting", "https://console.dev/browser-testing/crossbrowsertesting/"],
            ["/browser-testing/ghost-inspector", "https://console.dev/browser-testing/ghost-inspector/"],
            ["/browser-testing/lambdatest", "https://console.dev/browser-testing/lambdatest/"],
            ["/browser-testing/sauce-labs", "https://console.dev/browser-testing/sauce-labs/"],
            ["/browser-testing/selenium", "https://console.dev/browser-testing/selenium/"],
            ["/code-collaboration-pair-programming", "https://console.dev/code-collaboration-pair-programming/"],
            ["/load-testing", "https://console.dev/load-testing/"],
            ["/server-monitoring", "https://console.dev/server-monitoring/"],
            ["/website-monitoring", "https://console.dev/website-monitoring/"],
            ["/tools/browser-testing", "https://console.dev/browser-testing/"],
            ["/tools/code-collaboration-pair-programming", "https://console.dev/code-collaboration-pair-programming/"],
            ["/tools/load-testing", "https://console.dev/load-testing/"],
